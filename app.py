...
with st.container(border=True):
    ...
    m2.metric(f"Force at current angle ({theta_deg:.0f}°)", fmt_pk(F_here_pc),
              help="Force at the current wall angle (the red marker on the plots — set "
                   "with the θ slider), per cylinder.")
